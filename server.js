...
app.get("/", function (req, res) {
  ...
  res.send(`ipAddresses : ${req.ipInfo}`);
...
//   cert: fs.readFileSync('/etc/letsencrypt/live/primeexperia.com/cert.pem','utf8'),
//   key: fs.readFileSync('/etc/letsencrypt/live/primeexperia.com/privkey.pem','utf8')
// },app);
